...
import static com.modernbank.authentication_service.constants.JwtSecrets.JWT_CRTPYO_SECRET;
import static com.modernbank.authentication_service.constants.JwtSecrets.JWT_SECRET;

@Service
@Slf4j
@RequiredArgsConstructor
public class JwtService {
    private static final int EXPIREDATE = 1000 * 60 * 60 * 24/**Minute   1000 60 1 1DAKIKA DEMEK...**/
            ;
